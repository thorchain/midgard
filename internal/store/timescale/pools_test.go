...
func (s *TimeScaleSuite) TestExists(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	exists, err := s.Store.IsPoolExists(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestAssetStakedTotal(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	assetStakedTotal, err := s.Store.GetPoolAssetStakedTotal(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestRuneStakedTotal(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	runeStakedTotal, err := s.Store.GetPoolRuneStakedTotal(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestPoolStakedTotal(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	poolStakedTotal, err := s.Store.GetPoolStakedTotal(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestAssetDepth(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	assetDepth, err := s.Store.GetPoolAssetDepth(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestRuneDepth(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	runeDepth, err := s.Store.GetPoolRuneDepth(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestRuneDepth12m(c *C) {
	...
	runeDepth, err = s.Store.GetPoolAssetDepth(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestPoolDepth(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	poolDepth, err := s.Store.GetPoolDepth(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestPoolUnits(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	poolUnits, err := s.Store.GetPoolUnits(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestSellVolume(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	volume, err := s.Store.GetPoolSellVolume(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestBuyVolume(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	volume, err := s.Store.GetPoolBuyVolume(asset)
	c.Assert(err, IsNil)
	c.Assert(volume, Equals, uint64(0))
...
func (s *TimeScaleSuite) TestPoolVolume(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	volume, err := s.Store.GetPoolVolume(asset)
	c.Assert(err, IsNil)
	c.Assert(volume, Equals, uint64(0))
...
func (s *TimeScaleSuite) TestPoolVolume24hr(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	volume, err := s.Store.GetPoolVolume24hr(asset)
	c.Assert(err, IsNil)
	c.Assert(volume, Equals, uint64(0))
...
func (s *TimeScaleSuite) TestSellTxAverage(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BOLT-014")
	txAverage, err := s.Store.GetPoolSellTxAverage(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestBuyTxAverage(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BOLT-014")
	txAverage, err := s.Store.GetPoolBuyTxAverage(asset)
	c.Assert(err, IsNil)
	c.Assert(txAverage, Equals, float64(0))
...
func (s *TimeScaleSuite) TestPoolTxAverage(c *C) {
	...
	txAverage, err := s.Store.GetPoolTxAverage(asset)
	c.Assert(err, IsNil)
	c.Assert(txAverage, Equals, float64(0))
...
func (s *TimeScaleSuite) TestSellSlipAverage(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BOLT-014")
	slipAverage, err := s.Store.GetPoolSellSlipAverage(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestBuySlipAverage(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BOLT-014")
	slipAverage, err := s.Store.GetPoolBuySlipAverage(asset)
	c.Assert(err, IsNil)
	c.Assert(slipAverage, Equals, 0.0)
...
func (s *TimeScaleSuite) TestPoolSlipAverage(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BOLT-014")
	slipAverage, err := s.Store.GetPoolSlipAverage(asset)
	c.Assert(err, IsNil)
	c.Assert(slipAverage, Equals, 0.0)
...
func (s *TimeScaleSuite) TestSellFeeAverage(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BOLT-014")
	feeAverage, err := s.Store.GetPoolSellFeeAverage(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestBuyFeeAverage(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BOLT-014")
	feeAverage, err := s.Store.GetPoolBuyFeeAverage(asset)
	c.Assert(err, IsNil)
	c.Assert(feeAverage, Equals, float64(0))
...
func (s *TimeScaleSuite) TestPoolFeeAverage(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BOLT-014")
	feeAverage, err := s.Store.GetPoolFeeAverage(asset)
	c.Assert(err, IsNil)
	c.Assert(feeAverage, Equals, float64(0))
...
func (s *TimeScaleSuite) TestSellFeesTotal(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	feesTotal, err := s.Store.GetPoolSellFeesTotal(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestBuyFeesTotal(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	feesTotal, err := s.Store.GetPoolBuyFeesTotal(asset)
	c.Assert(err, IsNil)
	c.Assert(feesTotal, Equals, uint64(0))
...
func (s *TimeScaleSuite) TestPoolFeesTotal(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	feesTotal, err := s.Store.GetPoolFeesTotal(asset)
	c.Assert(err, IsNil)
	c.Assert(feesTotal, Equals, uint64(0))
...
func (s *TimeScaleSuite) TestSellAssetCount(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	assetCount, err := s.Store.GetPoolSellAssetCount(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestBuyAssetCount(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	assetCount, err := s.Store.GetPoolBuyAssetCount(asset)
	c.Assert(err, IsNil)
	c.Assert(assetCount, Equals, uint64(0))
...
func (s *TimeScaleSuite) TestSwappingTxCount(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	swappingCount, err := s.Store.GetPoolSwappingTxCount(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestSwappersCount(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	swappersCount, err := s.Store.GetPoolSwappersCount(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestStakeTxCount(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	stakeCount, err := s.Store.GetPoolStakeTxCount(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestWithdrawTxCount(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	withdrawCount, err := s.Store.GetPoolWithdrawTxCount(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestStakingTxCount(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	stakingCount, err := s.Store.GetPoolStakingTxCount(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestStakersCount(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	stakersCount, err := s.Store.GetPoolStakersCount(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestAssetROI(c *C) {
	// No stake
	asset, _ := common.NewAsset("BNB.BNB")
	roi, err := s.Store.GetPoolAssetROI(asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestRuneROI(c *C) {
	...
	// No stake
	roi, err := s.Store.GetPoolRuneROI(asset)
	c.Assert(err, IsNil)
	c.Assert(roi, Equals, 0.0)
...
func (s *TimeScaleSuite) TestPoolROI(c *C) {
	...
	// No stake
	roi, err := s.Store.GetPoolROI(asset)
	c.Assert(err, IsNil)
	c.Assert(roi, Equals, 0.0)
