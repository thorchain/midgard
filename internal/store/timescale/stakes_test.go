...
func (s *TimeScaleSuite) TestStakeUnits(c *C) {
	...
	// No stakes
	stakeUnits, err := s.Store.GetStakerStakeUnits(address, asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestRuneStaked(c *C) {
	...
	// No stakes
	runeStaked, err := s.Store.GetStakerRuneStaked(address, asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestAssetStakedForAddress(c *C) {
	...
	// No stakes
	assetStaked, err := s.Store.GetStakerAssetStaked(address, asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestPoolStaked(c *C) {
	...
	// No stakes
	poolStaked, err := s.Store.GetStakerPoolStaked(address, asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestRuneEarned(c *C) {
	...
	// No stakes
	runeEarned, err := s.Store.GetStakerRuneEarned(address, asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestAssetEarned(c *C) {
	...
	// No stakes
	assetEarned, err := s.Store.GetStakerAssetEarned(address, asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestPoolEarned(c *C) {
	...
	// No stakes
	poolEarned, err := s.Store.GetStakerPoolEarned(address, asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestStakersRuneROI(c *C) {
	...
	// No stakes
	runeROI, err := s.Store.GetStakerRuneROI(address, asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestDateFirstStaked(c *C) {
	...
	// No stakes
	dateFirstStaked, err := s.Store.GetStakerDateFirstStaked(address, asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestStakersAssetROI(c *C) {
	...
	// No stakes
	assetROI, err := s.Store.GetStakersAssetROI(address, asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestStakersPoolROI(c *C) {
	...
	// No stakes
	poolROI, err := s.Store.GetStakerPoolROI(address, asset)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestGetPools(c *C) {
	...
	// No stakes
	pools, err := s.Store.GetStakerPools(address)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestTotalEarned(c *C) {
	...
	// No stakes
	totalEarned, err := s.Store.GetStakerTotalEarned(address, assets)
	c.Assert(err, IsNil)
...
func (s *TimeScaleSuite) TestTotalROI(c *C) {
	...
	// No stakes
	totalROI, err := s.Store.GetStakerTotalROI(address)
	c.Assert(err, IsNil)
