...
lint-pre:
	@gofumpt -l api/rest/v1/{handlers,helpers} cmd internal tools # for display
	@test -z "$(shell gofumpt -l api/rest/v1/{handlers,helpers} cmd internal tools)" # cause error
	@go mod verify
